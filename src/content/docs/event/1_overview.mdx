...
Hosting is handled by AWS Elastic Beanstalk on the Ruby platform, while the domain is managed by Onamae (hopefully transitioning to Cloudflare in August) while Route 53 is the authoritative nameserver. The database is an RDS postgres instance, email is handled by SES and object storage by S3.
...
#### Admins
  ...
  - Can create new Events
    ...
    - And time slots
	- Can edit the automatically created options for any time slot
