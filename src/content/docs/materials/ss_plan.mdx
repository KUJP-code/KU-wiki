...
Trying to prioritise parent-facing features as it gives us a handy smaller scope to work within and will have an obvious benefit to customers/allow us to start moving them off My Page early.
...
4. [Lessons/contracts/courses/rooms/reservation slots/misc](#lessonscontractscoursesroomsreservation-slotsmisc) ~ ??????

	I cannot untangle this without walking through it with someone who knows it well.
